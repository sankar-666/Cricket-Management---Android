...
public class ViewExtrasScore extends AppCompatActivity implements JsonResponse {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_extras_score);
        ...
        JR.json_response=(JsonResponse) ViewExtrasScore.this;
        String q = "/viewextras?mid="+ViewMatch.match_id;
        q=q.replace(" ","%20");
        JR.execute(q);
    }
    ...
    public void response(JSONObject jo) {
        try {
            ...
            if(method.equalsIgnoreCase("viewextras")){
                ...
                if(status.equalsIgnoreCase("success")){
                    ...
                    for(int i = 0;i<ja1.length();i++)
                    {
                        ...
                        runs[i]=ja1.getJSONObject(i).getString("runs");
